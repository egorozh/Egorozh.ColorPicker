    ...
    public class ScreenColorPicker : Control, IColorEditor
    {
        ...
        public ScreenColorPicker()
        {
            this.SetStyle(
                ...
                true);
            this.SetStyle(ControlStyles.Selectable | ControlStyles.StandardClick | ControlStyles.StandardDoubleClick,
                false);
            this.Zoom = 8;
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left && !this.IsCapturing)
            {
                if (_eyedropperCursor == null)
                {
                    _eyedropperCursor = PortExtensions.CreateEyedropperCursor();
                }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            this.OnPaintBackground(
                e); // HACK: Easiest way of supporting things like BackgroundImage, BackgroundImageLayout etc
            ...
            if (this.SnapshotImage != null)
            {
                ...
                e.Graphics.DrawImage(this.SnapshotImage,
                    new Rectangle(0, 0, this.SnapshotImage.Width * this.Zoom, this.SnapshotImage.Height * this.Zoom),
                    new Rectangle(Point.Empty, this.SnapshotImage.Size), GraphicsUnit.Pixel);
            }
        ...
        protected virtual void PaintAdornments(PaintEventArgs e)
        {
            ...
            {
                e.Graphics.DrawImage(this.Image, (this.ClientSize.Width - this.Image.Size.Width) / 2,
                    (this.ClientSize.Height - this.Image.Size.Height) / 2);
            }
