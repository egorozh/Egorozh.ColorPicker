...
namespace Egorozh.ColorPicker
{
    ...
    /// </summary>
    public static class ColorComparerNew
    {
        #region Constants
        ...
        public static int GetBrightness(this Color color)
        {
            ...
            return GetGamma(RedLuminance * GetInverseGamma(color.R) + GreenLuminance * GetInverseGamma(color.G) +
                            BlueLuminance * GetInverseGamma(color.B));
        }
