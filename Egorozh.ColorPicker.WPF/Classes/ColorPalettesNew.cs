...
{
    public static class ColorPalettesNew
    {
        #region Static Properties

        public static ColorCollectionNew HexagonPalette
        {
            get
            {
                return new ColorCollectionNew(new[]
                {
        ...
        public static ColorCollectionNew NamedColors
        {
            get
            {
                ...
                results.Sort(ColorComparerNew.Brightness);

                return new ColorCollectionNew(results);
            }
        }

        public static ColorCollectionNew Office2010Standard
        {
            get
            {
        ...
        public static ColorCollectionNew PaintPalette
        {
            get
            {
                return new ColorCollectionNew(new[]
        ...
        public static ColorCollectionNew QbColors
        {
            get
            {
                return new ColorCollectionNew(new[]
        ...
        public static ColorCollectionNew StandardPalette
        {
            get
            {
                return new ColorCollectionNew(new[]
        ...
        public static ColorCollectionNew WebSafe
        {
            get
            {
                return new ColorCollectionNew(new[]
        ...
        public static ColorCollectionNew GetPalette(ColorPalette palette)
        {
            ColorCollectionNew result;
        ...
        public static ColorCollectionNew ScaledPalette(IEnumerable<Color> topRow)
        {
